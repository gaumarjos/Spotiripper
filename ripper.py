...
class Ripper:
    ...
    def rip(self, trackuri):
        ...
        #
        # TODO
        #  It needs some testing to check this works fine (like, stop too late or too early).
